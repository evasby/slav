...
drupal_add_js(drupal_get_path('theme', 'slav') . '/js/canvas3.js');
drupal_add_js(drupal_get_path('theme', 'slav') . '/js/canvas4.js');
?>
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="hide">
    ...
    <div id="term38" class="object"><?php $term = taxonomy_term_load(38); ?>
    ...
    <div id="term39" class="object"><?php $term = taxonomy_term_load(39); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term40" class="object"><?php $term = taxonomy_term_load(40); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
