...
drupal_add_js(drupal_get_path('theme', 'slav') . '/js/canvas2.js');
?>
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="hide">
    ...
    <div id="term30" class="object"><?php $term = taxonomy_term_load(30); ?>
    ...
    <div id="term31" class="object"><?php $term = taxonomy_term_load(31); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term32" class="object"><?php $term = taxonomy_term_load(32); ?>
      <div class="object_title"></div>
      <div class="object_inner">
         <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term33" class="object"><?php $term = taxonomy_term_load(33); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term34" class="object"><?php $term = taxonomy_term_load(34); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term35" class="object"><?php $term = taxonomy_term_load(35); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term36" class="object"><?php $term = taxonomy_term_load(36); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
    ...
    <div id="term37" class="object"><?php $term = taxonomy_term_load(37); ?>
      <div class="object_title"></div>
      <div class="object_inner">
        <div class="object_text">
          <div class="object_head"><?php print $term->name; ?></div>
