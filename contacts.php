  ...
  <header class="header">
    <div class="inner">
      <div class="header_top">
        ...
        <div class="header_phone"><span></span>+375 (17) 289 90 92<br>+375 (29) 658 62 58<a href="/">Заказать звонок</a></div>
      </div>
      <nav class="menu">
        <ul class="menu_list">
          <li class="menu_item">
          ...
          <li class="menu_item">
            ...
            <ul class="menu_list menu_list__l2">
              <li class="menu_item menu_item__l2">
                <a href="/" class="menu_link menu_link__l2">Офисная часть</a>
              </li>
              <li class="menu_item menu_item__l2">
                <a href="/" class="menu_link menu_link__l2">Торговая и административная часть</a>
              </li>
              <li class="menu_item menu_item__l2">
                <a href="/" class="menu_link menu_link__l2">Ресторан</a>
              </li>
            </ul>
          </li>
          <li class="menu_item">
            <a href="how.php" class="menu_link">Как мы работаем</a>
          </li>
          <li class="menu_item">
            <a href="partners.php" class="menu_link">Партнеры</a>
          </li>
          <li class="menu_item">
      ...
      <div class="contacts">
        <div class="feedback">
          ...
          <div class="feedback_inputwrap">
            <div class="feedback_label">Ваше имя:<sup>*</sup></div>
            <input type="text">
          </div>
          <div class="feedback_inputwrap">
            <div class="feedback_label">Телефон:<sup>*</sup></div>
            <input type="text">
          </div>
          <div class="feedback_inputwrap">
            <div class="feedback_label">Ваше e-mail:<sup>*</sup></div>
            <input type="text">
          </div>
          <div class="feedback_textareawrap">
            <div class="feedback_label">Ваше сообщение:<sup>*</sup></div>
        ...
        <div class="info">
          ...
          <div class="info_item">
            ...
            <div class="info_head">Адрес:</div>
            г. Минск, ул. Забицкая, 9-42
          </div>
          <div class="info_item">
            <div class="info_icon info_icon__phone"></div>
            <div class="info_head">Контактные телефоны:</div>
            +375 (17) 289 90 92<br>+375 (17) 289 18 90<br>+375 (29) 658 62 58
          </div>       
          <div class="info_item">
            <div class="info_icon info_icon__skype"></div>
            <div class="info_head">Skype:</div>
            Slavichi.Slavichi
          </div>
        </div>  
      </div>
